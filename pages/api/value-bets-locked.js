...
const MIN_ODDS = Number(process.env.MIN_ODDS_1X2 || 1.5); // ne moraš dodavati ENV; default 1.5
...
export default async function handler(req,res){
  try{
    ...
    // filter: izbaci poznate kvote < 1.5; null ostavi
    ...
    return res.status(200).json({ok:true,slot,ymd,items,tickets,source:srcKey,policy_cap:cap,slot_cap:cap,debug:{reads:tried}, min_odds: MIN_ODDS});
