...
function Outcome({ won }) {
  ...
  return null; // History prikazuje samo završene; ako server ipak ne pošalje 'won', ne renderuj badge
}
...
export default function HistoryPanel({ label = "History" }) {
  ...
  useEffect(() => {
    (async () => {
      ...
      // Endpoint već vraća ono što hoćeš; defanzivno zadržavamo samo završene.
